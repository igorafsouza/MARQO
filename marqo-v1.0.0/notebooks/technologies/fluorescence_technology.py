...
class IFTechnology(Technology):
    ...
    def initialization_widgets(self):
        widgets_func = [raw_images_path, output_path, sample_name, marker_name_list, dna_marker, ref_channels, cyto_distances, output_resolution]
    ...
    def initialization(self):
        self.pipeline.initialization(self.image_names.values(), self.sample_name, self.marker_name_list, self.dna_marker, self.ref_channels, self.output_resolution, self.raw_images_path, self.output_path, self.cyto_distances)
    ...
    def _set_attributes(self, **kwargs):
        ...
        self.markers = [kwargs['dna_marker']]
